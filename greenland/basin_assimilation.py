...
# parameters needed if 'nonlinear_solver' = 'snes' :
...
# parameters needed if 'nonlinear_solver' = 'newton' :
...
params['nonlinear_solver']                          = 'newton' #'snes'
...
config['velocity']['use_lat_bcs']         = True
